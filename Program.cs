        ...
        static void Main(string[] args)
        {
            ...
            while (curr_pattern != "no")
            {
                ...
                while (curr_tree != "no")
                {
                    ...
                    Console.WriteLine(roots[0].high);
                    Console.WriteLine(roots[1].high);
                    Console.WriteLine(roots[2].high);
                    Console.WriteLine(roots[3].high);
                    Console.WriteLine(roots[4].high);
